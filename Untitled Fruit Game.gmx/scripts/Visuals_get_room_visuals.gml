...
switch(argument0) {
    ...
    case rStrawberry:
        Visuals_add_object_sprite(
            objMiniUp,     sprStrawberrySpikeUp,
            objMiniRight,  sprStrawberrySpikeRight,
            objMiniDown,   sprStrawberrySpikeDown,
            objMiniLeft,   sprStrawberrySpikeLeft,
        );
        break;
    case rWatermelon:
        Visuals_add_object_sprite(
            objSpikeUp,    sprWatermelonSpikeUp,
            objSpikeRight, sprWatermelonSpikeRight,
            objSpikeDown,  sprWatermelonSpikeDown,
            objSpikeLeft,  sprWatermelonSpikeLeft,
            objMiniUp,     sprWatermelonMiniUp,
            objMiniRight,  sprWatermelonMiniRight,
            objMiniDown,   sprWatermelonMiniDown,
