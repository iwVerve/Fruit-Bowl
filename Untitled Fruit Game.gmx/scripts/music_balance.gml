...
audio_sound_gain(music_load("Cutie"), 0.7, 0);
audio_sound_gain(music_load("LoopScratch"), 0.7, 0);
audio_sound_gain(music_load("Love"), 0.7, 0);
audio_sound_gain(music_load("MelodyOfSmallLove"), 0.7, 0);
